...
// Get from console
// =================================================
//#define AWS_IOT_MQTT_HOST              "A7RDHYR0RGGZ.iot.us-west-2.amazonaws.com"
//#define AWS_IOT_MQTT_PORT              8883
//#define AWS_IOT_MQTT_CLIENT_ID         "NGM-SIMDEV-02"
//#define AWS_IOT_MY_THING_NAME 		   "NGM-SIMDEV-02"
...
#define AWS_IOT_MQTT_NUM_SUBSCRIBE_HANDLERS 64 ///< Maximum number of topic filters the MQTT client can handle at any given time. This should be increased appropriately when using Thing Shadow
...
#define MAX_JSON_TOKEN_EXPECTED 2048 ///< These are the max tokens that is expected to be in the Shadow JSON document. Include the metadata that gets published
#define MAX_SHADOW_TOPIC_LENGTH_WITHOUT_THINGNAME 1024 ///< All shadow actions have to be published or subscribed to a topic which is of the format $aws/things/{thingName}/shadow/update/accepted. This refers to the size of the topic without the Thing Name
