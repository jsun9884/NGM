...
//                $mdSidenav('left').close();
    ...
    .run(['$templateCache', function($templateCache) {
        $templateCache.put('views/ss/menu-link.tmpl.html',
            ...
            '   <md-icon ng-if="section.icon" style="color: #727272">{{section.icon}}</md-icon>&nbsp;&nbsp;<span class="item-title">{{section.name}}</span>\n' +
        ...
        $templateCache.put('views/ss/menu-sidenav.tmpl.html',
            ...
            '        <h3 ss-style-color="{\'color\': \'primary.A100\'}" class="menu-heading md-subhead" ng-if="section.type === \'heading\'">' +
